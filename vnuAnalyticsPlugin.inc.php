...
/**
 * @file vnuAnalyticsPlugin.inc.php
 *
 * Copyright (c) 2014-2018 Simon Fraser University
 * Copyright (c) 2003-2018 John Willinsky
 * Copyright (c) 2019-2020 Cuong Tran
...
class vnuAnalyticsPlugin extends GenericPlugin {
	/**
	 * @copydoc Plugin::getDisplayName()
	 */
	function getDisplayName() {
		return "VNU Analytics";
	}
	...
	function callbackShowWebsiteSettingsTabs($hookName, $args) {
		...
		$output .= '<li><a name="vnuAnalytics" href="' . $dispatcher->url($request, ROUTE_COMPONENT, null, 'plugins.generic.vnuAnalytics.controllers.grid.AnalyticsGridHandler', 'index') . '">' . "VNU Analytics" . '</a></li>';
	...
	function setupGridHandler($hookName, $params) {
		$component =& $params[0];
		if ($component == 'plugins.generic.vnuAnalytics.controllers.grid.AnalyticsGridHandler') {
			// Allow the static page grid handler to get the plugin object
			import($component);
			AnalyticsGridHandler::setPlugin($this);
			return true;
		}
		return false;
	}
